...
dependencies:
  ...
  templates:
    - templates/output/access-matrix-tmpl.yaml
    - templates/output/change-release-plan-tmpl.yaml
    - templates/output/integration-spec-hl7v2-tmpl.yaml
    - templates/output/integration-spec-fhir-tmpl.yaml
    - templates/output/integration-spec-dicom-tmpl.yaml
    - templates/output/order-sets-governance-tmpl.yaml
    - templates/output/cds-safety-tmpl.yaml
    - templates/output/mdm-terminology-plan-tmpl.yaml
    - templates/output/rcm-charge-mapping-tmpl.yaml
    - templates/output/reporting-kpi-spec-tmpl.yaml
    - templates/output/data-quality-etl-plan-tmpl.yaml
    - templates/output/it-incident-rca-tmpl.yaml
    - templates/output/performance-observability-tmpl.yaml
    - templates/output/ehr-downtime-dr-playbook-tmpl.yaml
    - templates/output/api-catalog-governance-tmpl.yaml
    - templates/output/device-iot-integration-tmpl.yaml
    - templates/output/vendor-sla-plan-tmpl.yaml
    - templates/output/security-privacy-compliance-tmpl.yaml
    - templates/output/uat-training-plan-tmpl.yaml
    - templates/output/health-it-kpi-dashboard-spec-tmpl.yaml
    - templates/output/policy-sop-tmpl.yaml
    - templates/output/audit-report-tmpl.yaml
    - templates/output/risk-register-tmpl.yaml
  checklists:
    - checklists/access-provisioning-checklist.md
    - checklists/access-deprovisioning-checklist.md
    - checklists/change-request-checklist.md
    - checklists/release-go-live-checklist.md
    - checklists/hl7v2-mapping-checklist.md
    - checklists/fhir-conformance-checklist.md
    - checklists/dicom-routing-checklist.md
    - checklists/downtime-procedure-checklist.md
    - checklists/dr-test-checklist.md
    - checklists/data-migration-checklist.md
    - checklists/data-quality-checklist.md
    - checklists/cds-safety-checklist.md
    - checklists/order-set-build-qa-checklist.md
    - checklists/charge-capture-mapping-checklist.md
    - checklists/uat-test-case-checklist.md
    - checklists/security-privacy-incident-checklist.md
    - checklists/performance-troubleshoot-checklist.md
    - checklists/api-gateway-onboarding-checklist.md
    - checklists/vendor-sla-review-checklist.md
    - checklists/backup-restore-checklist.md
    - checklists/documentation-audit-health-it-checklist.md
  data:
    - templates/data/users.csv
    - templates/data/roles.csv
    - templates/data/access_matrix.csv
    - templates/data/patients.csv
    - templates/data/appointments.csv
    - templates/data/orders.csv
    - templates/data/results.csv
    - templates/data/charges.csv
    - templates/data/hl7_messages.csv
    - templates/data/fhir_imagingstudy.json
    - templates/data/interfaces.csv
    - templates/data/outage_incidents.csv
    - templates/data/perf_metrics.csv
